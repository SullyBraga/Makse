  ...
  return (
    <div>
      ...
      <section style={{ minHeight: 'calc(100vh - 96px)', display: 'flex', alignItems: 'center', backgroundColor: 'var(--cream)', position: 'relative', overflow: 'hidden' }}>
        {/* Background Image with elegant overlay to enhance visual richness while keeping high contrast for accessibility */}
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }} className="animate-fade">
          ...
          />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg, rgba(248, 250, 252, 0.4) 0%, rgba(248, 250, 252, 0.85) 100%)' }} />
        </div>
