...
## Corpus Check
- 116 files · ~592,876 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 478 nodes · 573 edges · 62 communities (41 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b58feaf5`
...
Cohesion: 0.20
Nodes (7): GET(), POST(), requireSeller(), POST(), POST(), TODO: Chamar API do Bling para baixa no estoque, TODO: Enviar email de confirmação
